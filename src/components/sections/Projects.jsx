    ...
    diagramNodes: [
      {
        ...
        col: 1, row: 1,
        desc: 'Incident reporting UI over HTTPS',
      },
      {
        id: 'api',
        label: 'Django REST (Railway)',
        ...
        col: 2, row: 1,
        desc: 'Backend on Railway — JWT auth & RBAC (Student, Admin, Dean, Official)',
      },
      {
        id: 'media',
        label: 'Cloudinary',
        ...
        col: 3, row: 1,
        desc: 'Incident image & media storage',
      },
      {
        id: 'db',
        label: 'Supabase DB',
        ...
        col: 2, row: 2,
        desc: 'PostgreSQL on Supabase — relational incident data',
      },
    ],
    diagramLines: [
      { from: 'client', to: 'api', animated: true },
      { from: 'api', to: 'db', animated: true },
      { from: 'api', to: 'media', animated: true },
    ],
  },
  {
    diagramNodes: [
