    ...
    <section id="projects" className="relative">
      ...
      <HorizontalScroll panelCount={PANEL_COUNT}>
        {projects.map((project, idx) => (
          <ScrollPanel key={idx}>
            <div className="w-full h-full flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 px-6 md:px-16 lg:px-24 py-6 md:py-8">
              {/* Image Side */}
              <motion.div
                ...
                >
                  <div className="aspect-[3/2] w-full flex items-center justify-center bg-black">
                    <img
                      ...
                      loading="lazy"
                      decoding="async"
                      className="w-full h-full grayscale group-hover:grayscale-0 transition-all duration-700 object-contain opacity-95 group-hover:opacity-100 [image-rendering:auto]"
                    />
                  </div>
                </div>
              ...
              <motion.div
                ...
                className="w-full md:w-[55%] lg:w-1/2 flex flex-col gap-4 md:gap-5"
              >
                ...
                {/* Links — placed before diagram so they stay visible */}
